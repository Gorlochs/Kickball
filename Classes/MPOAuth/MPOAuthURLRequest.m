...
- (NSURLRequest  *)urlRequestSignedWithSecret:(NSString *)inSecret usingMethod:(NSString *)inScheme {
	...
	//[self.parameters addObject:[[MPURLRequestParameter alloc] initWithName:@"fs_username" andValue:@"dave@deeplocal.com"]];
//	[self.parameters addObject:[[MPURLRequestParameter alloc] initWithName:@"fs_password" andValue:@"ramona12"]];
