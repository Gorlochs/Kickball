...
- (void) displayMayorImage {
    ...
    checkinDisplayLabel.frame = CGRectMake(71.0, checkinDisplayLabel.frame.origin.y, checkinDisplayLabel.frame.size.width, checkinDisplayLabel.frame.size.height);
}

- (void) hideMayorImage {
    mayorImage.image = nil;
    checkinDisplayLabel.frame = CGRectMake(52.0, checkinDisplayLabel.frame.origin.y, checkinDisplayLabel.frame.size.width, checkinDisplayLabel.frame.size.height);
}
