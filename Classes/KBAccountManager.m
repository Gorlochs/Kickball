...
-(void)displayCrossPollinateWarning{
	...
	if (numberTimesDisplayed<2) {
		KBMessage *message = [[KBMessage alloc] initWithMember:@"FYI" andMessage:@"If you have already linked your Twitter and Facebook accounts, you may see your posts appear twice."];
