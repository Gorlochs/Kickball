 ...
 * TODO How to use:
 */
@interface FacebookAgent : NSObject<FBDialogDelegate, FBSessionDelegate, FBRequestDelegate,FacebookAgentDelegate> {
	...
	/**
	 * part of scott's hack for auto logging in and checking permissions
	 */
	BOOL doingLogin;
}
