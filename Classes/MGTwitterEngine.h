...
- (NSString *)getFollowedTimelineSinceID:(unsigned long long)sinceID withMaximumID:(unsigned long)maxID startingAtPage:(int)pageNum count:(int)count; // statuses/friends_timeline
...
- (NSString *)getFavoritesForUser:(NSString *)username withCursor:(NSNumber*)cursor; // statuses/favorites
